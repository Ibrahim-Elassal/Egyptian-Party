// slidebar 
$(function (){
    let slidBarInnerWidth= $(".side_inner").innerWidth() ;
    $(".sidebar").css('left' , -slidBarInnerWidth)

    $(".sidebar span").click (function (){
        if($(".sidebar").css('left') == '0px'){
            $(".sidebar").animate({left:-slidBarInnerWidth } , 500 ) ;
            $(".eventOverlay").animate({left: 0 }  , 500  )
        }
        else {
            $(".sidebar").animate({left:0 } , 500 )
            $(".eventOverlay").animate({left: slidBarInnerWidth }  , 500  )
...
let time = setInterval(()=>{
    let finishTime = new Date("dec 15, 2023 00:00:00").getTime()
...
document.getElementById("textArea").addEventListener("input", _=>{
    validMessage()
